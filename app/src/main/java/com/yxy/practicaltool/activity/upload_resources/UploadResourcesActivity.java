    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_upload_2:
                ActivitySimpleEdit.startSimpleEdit(this, "产品名", "输入产品名", name2, ActivitySimpleEdit.INPUT_NAME, 20, 102);
                break;
            ...
            case R.id.ll_upload_4:
                ActivitySimpleEdit.startSimpleEdit(this, "产品数量", "输入产品数量", num4, ActivitySimpleEdit.INPUT_NUM, 8, 104);
                break;
            case R.id.ll_upload_5:
                ActivitySimpleEditLines.startSimpleEdit(this, "质量描述", "输入质量描述", des5, ActivitySimpleEditLines.INPUT_NAME, 200, 105);
                break;
            case R.id.ll_upload_6:
                ActivitySimpleEditLines.startSimpleEdit(this, "产品备注", "输入产品备注", tip6, ActivitySimpleEditLines.INPUT_NAME, 200, 106);
                break;
