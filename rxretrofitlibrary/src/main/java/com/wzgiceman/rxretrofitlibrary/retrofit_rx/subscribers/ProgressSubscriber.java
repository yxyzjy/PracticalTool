...
public class ProgressSubscriber<T> extends Subscriber<T> {
        ...
        if (api.isCache() && AppUtil.isNetworkAvailable(RxRetrofitApp.getApplication())) {
            ...
            if (cookieResulte != null) {
                ...
                if (time < api.getCookieNetWorkTime()) {
                    if (mSubscriberOnNextListener.get() != null) {
                        mSubscriberOnNextListener.get().onNext(cookieResulte.getResulte() == null ? "" : cookieResulte.getResulte(),api.getMethod());
                    }
                    onCompleted();
                    unsubscribe();
                }
    ...
    public void onCompleted() {
        ...
        if (mSubscriberOnNextListener.get() != null) {
            mSubscriberOnNextListener.get().onCompleted(api.getMethod());
        }
    }
    ...
    private void errorDo(Throwable e) {
        ...
        if (e instanceof SocketTimeoutException) {
            ...
            Toast.makeText(context, "errorDo" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
        if (mSubscriberOnNextListener.get() != null) {
            mSubscriberOnNextListener.get().onError(e,api.getMethod());
            mSubscriberOnNextListener.get().onCompleted(api.getMethod());
        }
    }
    ...
    public void onNext(T t) {
        ...
        if (mSubscriberOnNextListener.get() != null) {
            if (t == null) {
                mSubscriberOnNextListener.get().onNext("", api.getMethod());
            } else {
